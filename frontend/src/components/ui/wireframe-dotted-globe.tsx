...
export default function RotatingEarth({ width = 800, height = 600, className = "" }: RotatingEarthProps) {
  ...
  useEffect(() => {
    ...
    if (currentCanvas) {
        ...
        currentCanvas.addEventListener("wheel", handleWheel)
    }
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      />
      <div className="absolute bottom-4 left-4 text-xs text-muted-foreground px-2 py-1 rounded-md dark bg-neutral-900/50 backdrop-blur-sm">
